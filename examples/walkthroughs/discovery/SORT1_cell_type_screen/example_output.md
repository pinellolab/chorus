...
- **Cell types**: HepG2
- **Generated**: 2026-08-11 04:36 UTC
...
| Track | Ref | Alt | Effect | Effect %ile | Activity %ile | Interpretation |
|---|---|---|---|---|---|---|
| CHIP:ARID3A:HepG2 | 2e+03 | 4.07e+03 | +1.023 | 0.9973 | 0.997 | Very strong binding gain |
| CHIP:ARID3A:HepG2 | 1.58e+03 | 3.06e+03 | +0.955 | 0.9972 | 0.992 | Very strong binding gain |
| CHIP:ARID4B:HepG2 | 3.01e+03 | 5.38e+03 | +0.837 | 0.9960 | 0.937 | Very strong binding gain |
| CHIP:AHDC1:HepG2 | 951 | 1.63e+03 | +0.773 | 0.9982 | 0.997 | Very strong binding gain |
| CHIP:ARID4A:HepG2 | 1.14e+03 | 1.84e+03 | +0.691 | 0.9984 | 0.918 | Strong binding gain |
| CHIP:AFF4:HepG2 | 957 | 1.53e+03 | +0.676 | 0.9985 | 0.943 | Strong binding gain |
| CHIP:AHR:HepG2 | 1.33e+03 | 1.93e+03 | +0.542 | 0.9974 | 0.914 | Strong binding gain |
| CHIP:ARID2:HepG2 | 583 | 826 | +0.502 | 0.9977 | 0.939 | Strong binding gain |
| CHIP:AKAP8:HepG2 | 986 | 1.39e+03 | +0.497 | 0.9977 | 0.938 | Strong binding gain |
| CHIP:ARHGAP35:HepG2 | 854 | 1.09e+03 | +0.353 | 0.9968 | 0.911 | Strong binding gain |
...
| CHIP:H3K9ac:HepG2 | 1.47e+04 | 2.45e+04 | +0.730 | 0.9984 | 0.905 | Very strong mark gain |
| CHIP:H3K4me3:HepG2 | 8.14e+03 | 1.13e+04 | +0.475 | 0.9972 | 0.881 | Strong mark gain |
| CHIP:H3K27me3:HepG2 | 1.2e+03 | 868 | -0.467 | 0.9998 | 0.425 | Strong mark loss |
| CHIP:H4K20me1:HepG2 | 1.1e+03 | 850 | -0.368 | 0.9993 | 0.278 | Strong mark loss |
| CHIP:H3K36me3:HepG2 | 1.12e+03 | 882 | -0.347 | 0.9997 | 0.730 | Strong mark loss |
| CHIP:H3K4me2:HepG2 | 2.54e+04 | 3.22e+04 | +0.341 | 0.99 | 0.946 | Strong mark gain |
| CHIP:H3K9me3:HepG2 | 513 | 437 | -0.228 | 0.9979 | 0.139 | Moderate mark loss |
| CHIP:H3K79me2:HepG2 | 1.09e+03 | 1.23e+03 | +0.174 | 0.9939 | 0.705 | Moderate mark gain |
...
| RNA:HepG2 — CELSR2 (exons) | 0.184 | 0.289 | +0.449 | 0.9998 | 0.462 | Strong increase |
| RNA:HepG2 — PSRC1 (exons) | 0.739 | 1.15 | +0.441 | 0.9998 | 0.689 | Strong increase |
...
| RNA:HepG2 — PSRC1 (exons) | 0.00193 | 0.00322 | +0.364 | 0.9998 | 0.458 | Strong increase |
| RNA:HepG2 — CELSR2 (exons) | 0.103 | 0.148 | +0.362 | 0.9998 | 0.697 | Strong increase |
| RNA:HepG2 — PSRC1 (exons) | 1.21 | 1.58 | +0.268 | 0.9998 | 0.885 | Moderate increase |
| RNA:HepG2 — MYBPHL (exons) | 0.0796 | 0.102 | +0.243 | 0.9998 | 0.383 | Moderate increase |
...
- **Cell types**: MCF 10A
- **Generated**: 2026-08-11 04:37 UTC
...
| Track | Ref | Alt | Effect | Effect %ile | Activity %ile | Interpretation |
|---|---|---|---|---|---|---|
| DNASE:MCF 10A | 338 | 919 | +1.440 | 0.9938 | 0.931 | Very strong opening |
...
| Track | Ref | Alt | Effect | Effect %ile | Activity %ile | Interpretation |
|---|---|---|---|---|---|---|
| RNA:MCF 10A — PSRC1 (exons) | 0.0032 | 0.00387 | +0.148 | 0.9996 | 0.476 | Moderate increase |
| RNA:MCF 10A — PSRC1 (exons) | 0.367 | 0.414 | +0.120 | 0.9994 | 0.783 | Moderate increase |
| RNA:MCF 10A — CELSR2 (exons) | 0.000445 | 0.000576 | +0.086 | 0.9992 | 0.323 | Moderate increase |
| RNA:MCF 10A — MYBPHL (exons) | 0.000636 | 0.000738 | +0.061 | 0.9984 | 0.347 | Moderate increase |
| RNA:MCF 10A — CELSR2 (exons) | 0.527 | 0.549 | +0.041 | 0.9976 | 0.815 | Minimal effect |
| RNA:MCF 10A — SORT1 (exons) | 0.000442 | 0.000474 | +0.022 | 0.9950 | 0.316 | Minimal effect |
| RNA:MCF 10A — SORT1 (exons) | 0.531 | 0.54 | +0.016 | 0.9930 | 0.816 | Minimal effect |
| RNA:MCF 10A — MYBPHL (exons) | 0.000431 | 0.000448 | +0.012 | 0.9904 | 0.320 | Minimal effect |
| RNA:MCF 10A — SARS1 (exons) | 0.0115 | 0.0116 | +0.006 | 0.98 | 0.575 | Minimal effect |
| RNA:MCF 10A — SYPL2 (exons) | 0.00488 | 0.00484 | -0.006 | -0.97 | 0.506 | Minimal effect |
| _…showing top 10 of 58 — see `example_output.json` for the full set_ | | | | | | |
...
| Track | Ref | Alt | Effect | Effect %ile | Activity %ile | Interpretation |
|---|---|---|---|---|---|---|
| DNASE:amniotic epithelial cell | 53 | 401 | +2.898 | 0.9986 | 0.840 | Very strong opening |

#### TSS activity (CAGE/PRO-CAP)

| Track | Ref | Alt | Effect | Effect %ile | Activity %ile | Interpretation |
|---|---|---|---|---|---|---|
| CAGE:amniotic epithelial cell — variant site | 83.7 | 54.6 | -0.607 | 0.9945 | 0.945 | Strong decrease |
