...
| DNASE:DND-41 | 1.4e+03 | 1.82e+03 | +0.384 | 0.97 | 0.949 | Strong opening |
...
| CHIP:MAX:K562 | 2.1e+04 | 2.77e+04 | +0.400 | 0.98 | 0.997 | Strong binding gain |
...
| CAGE:K562 — SLC6A19 TSS | 2.36 | 2.43 | +0.029 | 0.75 | 0.816 | Minimal effect |
| CAGE:Jurkat — SLC6A18 TSS | 0.332 | 0.352 | +0.021 | 0.65 | 0.368 | Minimal effect |
| CAGE:Jurkat — ZDHHC11B TSS | 155 | 154 | -0.016 | 0.58 | 0.951 | Minimal effect |
| CAGE:HL-60 — ZDHHC11B TSS | 33.9 | 33.6 | -0.012 | 0.53 | 0.926 | Minimal effect |
...
| Track | Ref | Alt | Effect | Effect %ile | Activity %ile | Interpretation |
|---|---|---|---|---|---|---|
| SPLICE_SITES | 0.0381 | 0.0652 | +0.037 | 0.97 | 0.806 | Minimal effect |
| SPLICE_SITES:HFFc6 | 0.0102 | 0.0197 | +0.013 | 0.97 | 0.852 | Minimal effect |
| SPLICE_SITES:dorsolateral prefrontal cortex | 0.0172 | 0.0246 | +0.010 | 0.96 | 0.850 | Minimal effect |
