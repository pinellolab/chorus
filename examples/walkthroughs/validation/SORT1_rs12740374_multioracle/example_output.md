...
- **Generated:** 2026-07-31 14:55 UTC

## Cross-oracle consensus

| Layer | chrombpnet | legnet | alphagenome | Agreement |
|---|---|---|---|---|
| Chromatin accessibility (DNASE/ATAC) (log2FC) | +1.376 · DNASE:HepG2 | — | +1.330 · DNASE:HepG2 | all ↑ |
| Promoter activity (MPRA) (Δ (alt−ref)) | — | +0.347 · LentiMPRA:HepG2 | — | only ↑ (n=1) |
| Transcription factor binding (ChIP-TF) (log2FC) | — | — | +2.764 · CHIP:CEBPA:HepG2 | only ↑ (n=1) |
| Histone modifications (ChIP-Histone) (log2FC) | — | — | +1.255 · CHIP:H3K27ac:HepG2 | only ↑ (n=1) |
