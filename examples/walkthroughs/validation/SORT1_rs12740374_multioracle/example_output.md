...
- **Generated:** 2026-08-01 03:26 UTC

## Cross-oracle consensus

| Layer | chrombpnet | legnet | alphagenome | Agreement |
|---|---|---|---|---|
| Chromatin accessibility (DNASE/ATAC) (log2FC) | +1.376 · DNASE:HepG2 | — | +1.334 · DNASE:HepG2 | all ↑ |
...
| Histone modifications (ChIP-Histone) (log2FC) | — | — | +1.263 · CHIP:H3K27ac:HepG2 | only ↑ (n=1) |
| TSS activity (CAGE/PRO-CAP) (log2FC) | — | — | +1.512 · CAGE:HepG2 | only ↑ (n=1) |