...
| **Cherimoya / CATv1** | 4 GB | optional | ~1 ms (GPU) / ~10 ms (CPU) per 1 kb query — inference only ⁑ | base-pair chromatin accessibility across 1,518 ENCODE DNase/ATAC experiments — the widest biosample coverage in chorus |
