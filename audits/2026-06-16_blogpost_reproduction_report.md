...
| AlphaGenome ranks rs9504151 #1 of credible set | rank 1 | AG fine-map (focused lung-fib tracks) **running** with T1+T2 fixes | _pending_ | will update; ChromBPNet result below already validates the fixed pipeline |
